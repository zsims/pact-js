...
var PactWeb = /** @class */ (function () {
    function PactWeb(config) {
        ...
        if (!lodash_1.isEmpty(this.opts.consumer) || !lodash_1.isEmpty(this.opts.provider)) {
            logger_1.logger.warn("Passing in consumer/provider to PactWeb is deprecated,\n        and will be removed in the next major version");
        }
        logger_1.logger.info("Setting up Pact using mock service on port: \"" + this.opts.port + "\"");
